  ...
  return (
    <div className="p-4 sm:ml-64">
      <div className="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        ...
        <div>
          <button onClick={() => setAddPop(!addPop)} className="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:bg-indigo-500 dark:hover:bg-indigo-600">Add Product</button>
        </div>
      </div>
      {addPop &&
            ...
            <form className="space-y-4 flex flex-col justify-center" onSubmit={handleAddProductForm}>
              ...
              <div className='grid grid-cols-2'>
                ...
                <div className="w-full min-w-[200px] px-5 py-2">
                  ...
                  <input onClick={() => setCatPop(!catPop)} type='text' readOnly id="categories" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type here..." name='categories' value={selectedTitles.join(', ')} onChange={handleProductChange} required />
                  <button onClick={() => setCatPop(!catPop)} className="mt-2 text-blue-600">{catPop ? 'Close Category List' : 'Select Categories'}</button>
